...
export const PermissionLevelSchema = z.enum(['ADMIN', 'USER', 'EDITOR']);
export const RoleSchema = z.enum(['COMPRADOR', 'FORNECEDOR', 'AMBOS']);
export const TypeOpportunitySchema = z.enum(['SERVICO', 'MATERIAL', 'LOCACAO']);
...
export type TypeOpportunity = z.infer<typeof TypeOpportunitySchema>;
