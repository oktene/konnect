   ...
   return (
      <div className="w-full h-screen lg:min-h-[600px] xl:min-h-[800px]">
         <div className="w-full h-screen flex items-center justify-center">
            <Card className="mx-auto w-screen min-w-sm md:max-w-3xl md:h-[calc(100vh-2rem) lg:max-w-7xl}">
               <CardHeader>
                     ...
                     <div className="grid gap-2">
                        <div className="flex items-start">
                           <Checkbox
                              ...
                              disabled={isSubmitting} // Desabilitar ao enviar
                           />
         ...
         <Dialog open={isDialogOpen}>
            ...
            >
               <DialogHeader>
                  ...
                  <DialogTitle>Cadastrando usuário e empresa</DialogTitle>
               </DialogHeader>
               <p>Aguarde enquanto estamos processando seu cadastro.</p>
            </DialogContent>
         </Dialog>
      </div>
   );
